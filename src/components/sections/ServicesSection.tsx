      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative w-full max-w-2xl mx-auto aspect-[16/9] mb-8">
            <Image
              src="/assets/media/e8967e0d1c944f10bc5a6732ceb5cd58.png"
              alt="Tingkatkan Peluang Karir"
              fill
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {services.map((service, i) => (
            <motion.div
              ...
              className="bg-white border border-gray-100 rounded-[23px] p-6 hover:shadow-md transition-shadow duration-300"
            >
